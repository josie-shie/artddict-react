  ...
  return (
    <>
      <div className="art-area index-web-padding d-flex flex-column">
        ...
        <div className="px-5 mt-5 mx-5 art-push">
          <h5 classnames="notoSansTC-md ">
            每日畫足最少14小時的Mr.
            Doodle，此行目的是參與Mira Place的聖誕企劃「DOO
            ...
            永遠都有源源不絕的創造力跟靈感，對 Mr.Doodle
            來說塗鴉不只是工作更是必要的發洩出口，幽默地說道自己可能會有先天性畫圖強迫症「OCD
            – Obsessive Compulsive
            Drawing」，一天不畫畫就覺得身子不對勁，對他來說唯一的『解藥』就是放肆地創作，他可以在不需要準備、構思的情況下隨性起筆，最驚人的是每日的畫圖時數居然多達
            14
            個小時。獨特的繪畫風格，凸顯他強烈的任人特色，使他跟許多大品牌像
            MTV、ADDIDAS 合作過，當被問到創作理念時，
            Mr.doodle
            在專訪裡解釋：「這些帶著傻氣的卡通似塗鴉，其實背後並沒有深層的意義，對我來說創作最大的目的是為大家帶來歡樂，純粹希望觀眾看了能感到開心。」他最大的野心是能夠創立一個由這些可愛的卡通塗鴉所構成的主題樂園。
          </h5>
        </div>
        ...
        <div className="art-push px-5 mx-5">
          <h5 classnames="notoSansTC-md">
            創作至今，Mr
        ...
        <div className="art-name art-push px-5 art-relative">
          ...
          <h5>
            ...
            <br />
            塗鴉先生（本名Sam
            Cox），於1994年出生於英國肯特郡。九歲開始其藝術生涯，對任何可以拿到的物體都作了塗鴉，並用塗鴉紙貼滿了他的臥室。他很快地創造了一種全新的視覺現象：標誌性的「DoodleLand」（塗鴉樂），密集的字符、物體和圖案不斷地增長和繁殖，展現出了他的宇宙觀。
            塗鴉先生的風格經常被形容成是「塗鴉義大利麵」，他的即興創作不僅入侵了畫布，而且還入侵了家具、書、地鐵站和服飾等，並創造了一個不斷擴展的世界，裡面充滿了各種新奇好玩的事物。
            塗鴉先生已在倫敦、首爾和東京舉辦了數次個展；並參加無數個藝術博覽會，例如倫敦插畫博覽會（2016年、2017年和2018年）、東京藝術博覽會2019、京都藝術博覽會2019、台北藝術博覽會2019，和在首爾舉行的2020
