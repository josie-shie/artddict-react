      ...
      <div className="userData col-12">
        <form>
          ...
          <div className="form-group d-flex">
            ...
            <input type="checkbox" className="fform-check-input" id="gender" />
            <label className="gender1">先生</label>
            <input type="checkbox" className="form-check-input" id="gender" />
          ...
          <button type="submit" className="btn btn-outline-dark editBtn">
            修改
          </button>
        </form>
      </div>
